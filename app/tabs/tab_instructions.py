    ...
    return html.Div([
                ...
                dbc.Accordion([
                    ...
                    dbc.AccordionItem([
                        ...
                        html.Ul([
                            ...
                            html.Li("Searchable data table with row expansion for full transcription"),
                        ]),
        ...
        dbc.Card([
            dbc.CardBody([
                ...
                html.Ul([
                    html.Li("Use dropdowns and sliders to filter data — all charts in the active tab update together."),
                    ...
                    html.Li("Click segments in sunburst and treemap charts to drill down into subcategories."),
                    html.Li("ECG playback: use Play / Pause / Reset buttons and the speed slider to control animation."),
                    html.Li("Data tables support sorting and filtering. Click a row to expand and view full transcription text."),
                ], className="instructions-section"),
            ]),
        ], className="mb-3"),
