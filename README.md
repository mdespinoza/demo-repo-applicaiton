...
| **Snake Game — Ready** — Hidden easter egg (`Ctrl+Shift+G`) with neon cyberpunk theme and control hints | <img src="docs/screenshots/snake-ready.png" alt="Snake Game Ready Screen" width="600"> |
| **Snake Game — Gameplay** — Active gameplay with glowing snake, pulsing food, visible grid, and CRT scanline effects | <img src="docs/screenshots/snake-gameplay.png" alt="Snake Game Gameplay" width="600"> |
| **Snake Game — Game Over** — Game over screen with score display, red death glow, and high score tracking | <img src="docs/screenshots/snake-gameover.png" alt="Snake Game Over" width="600"> |
